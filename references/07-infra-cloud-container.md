# Infrastructure Cloud And Container Review

## What to Check
Review Dockerfiles, compose files, Kubernetes manifests, reverse proxy config, cloud/IAM notes, security headers, environment variables, and least-privilege deployment posture.
