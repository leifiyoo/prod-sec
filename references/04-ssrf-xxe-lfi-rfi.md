# Server-Side Request And File Access Review

## What to Check
Review URL fetchers, XML parsers, upload/download handlers, path joins, archive extraction, template loaders, and file permission boundaries.
