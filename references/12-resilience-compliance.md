# Resilience And Compliance Review

## What to Check
Review backup strategy, restore evidence, rate-limit and abuse controls, ransomware readiness, data retention, GDPR/SOC2/ISO indicators, and policy mapping.
